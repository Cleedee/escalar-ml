    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.inner}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            <Text style={[styles.tableCell, styles.colPerfil, { color: '#3b82f6' }]}>Conservador</Text>
          ...
          <View style={styles.tableRow}>
            <Text style={[styles.tableCell, styles.colPerfil, { color: '#ef4444' }]}>Agressivo</Text>
        ...
        <Text style={styles.sectionTitle}>Combinando foco e perfil</Text>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            ...
            <Text style={[styles.tableCell, styles.colSmall, { color: '#3b82f6' }]}>Conservador</Text>
          </View>
          <View style={styles.tableRow}>
            <Text style={[styles.tableCell, { flex: 1 }]}>Brigando pelo título</Text>
            <Text style={[styles.tableCell, styles.colSmall]}>1.0</Text>
            <Text style={[styles.tableCell, styles.colSmall, { color: '#ef4444' }]}>Agressivo</Text>
          </View>
          <View style={styles.tableRow}>
